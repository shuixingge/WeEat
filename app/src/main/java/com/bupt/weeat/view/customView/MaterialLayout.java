...
public class MaterialLayout extends RelativeLayout {
    private static final String TAG=MaterialLayout.class.getSimpleName();
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mCirclelColor = typedArray.getColor(R.styleable.MaterialLayout_reveal_color, Color.LTGRAY);
        mDuration = typedArray.getInteger(R.styleable.MaterialLayout_duration,
                DEFAULT_DURATION);
        mFrameRate = typedArray
                .getInteger(R.styleable.MaterialLayout_frame_rate, DEFAULT_FRAME_RATE);
    ...
    private void removeExtraHeight() {
        ...
        // 获取中心点
        mCenterPoint = new android.graphics.Point(centerHorizontal, centerVertical);
